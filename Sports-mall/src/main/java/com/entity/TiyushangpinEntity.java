...
public class TiyushangpinEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public TiyushangpinEntity() {
		
	}
	
	public TiyushangpinEntity(T t) {
		try {
	...
	private String chanjiamingcheng;
	 ...
	 * 设置：产家名称
	 */
	public void setChanjiamingcheng(String chanjiamingcheng) {
		this.chanjiamingcheng = chanjiamingcheng;
	}
	/**
	 * 获取：产家名称
	 */
	public String getChanjiamingcheng() {
		return chanjiamingcheng;
	}
	/**
	 * 设置：生产地
	 */
