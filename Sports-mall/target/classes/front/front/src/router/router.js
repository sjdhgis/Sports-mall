...
import tiyushangpinList from '../pages/tiyushangpin/list'
import tiyushangpinDetail from '../pages/tiyushangpin/detail'
import tiyushangpinAdd from '../pages/tiyushangpin/add'
      ...
      redirect: '/index/home'
    },
		{
			...
			children:[
				...
				{
					path: 'tiyushangpin',
					component: tiyushangpinList
				},
				{
					path: 'tiyushangpinDetail',
					component: tiyushangpinDetail
				},
				{
					path: 'tiyushangpinAdd',
					component: tiyushangpinAdd
				},
			]
		},
		{
